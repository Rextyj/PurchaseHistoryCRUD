...
export const UPDATE_SUMMARY_SUCCESS: string = 'UPDATE_SUMMARY_SUCCESS';
...
export class AppActionUpdateSummarySuccess implements Action {
...
export type AppActions = AppActionAdd | AppActionDel |
    ...
    AppActionAssignOwner | AppActionUpdateSummary |
    AppActionLogout | AppActionUpdateSummarySuccess;